...
typedef enum {
    ...
    FILE_TRAN_ERR_WRITE_FLASH_ERROR = -5, /**< \if write flash error \else 写Flash错误 \endif */
...
typedef enum {
    ...
    FORMAT_MJPEG_TO_I420,      /**< MJPG to I420 */
    FORMAT_RGB888_TO_BGR,      /**< RGB888 to BGR */
    FORMAT_MJPEG_TO_NV21,      /**< MJPG to NV21 */
    FORMAT_MJPEG_TO_RGB888,    /**< MJPG to RGB888 */
} OBConvertFormat,
    ob_convert_format;

...
typedef enum {
    ...
    OB_PROP_DEPTH_MAX_DIFF_INT                    = 40, /**< \if English soft filter maxdiff param \else 软件滤波的maxdiff参数 \endif */
    OB_PROP_DEPTH_MAX_SPECKLE_SIZE_INT            = 41, /**< \if English soft filter maxSpeckleSize \else 软件滤波的maxSpeckleSize \endif */
    ...
    OB_PROP_RECTIFY2_BOOL              = 80, /**< \if English brt2r-rectify function switch (brt2r is a special module on mx6600), 0: Disable, 1: Rectify Enable \else  brt2r-rectify功能开关(brt2r是mx6600上的一个特殊模块)，0: Disable, 1: Rectify Enable \endif */
    ...
    OB_PROP_INDICATOR_LIGHT_BOOL       = 83, /**< \if English Indicator switch, 0: Disable, 1: Enable \else  指示灯开关，0: Disable， 1: Enable \endif */
    ...
    OB_PROP_BRT_BOOL                   = 86, /**< \if English BRT function switch (anti-background interference), 0: Disable, 1: Enable \else  BRT功能开关(抗背景干扰)，0: Disable， 1: Enable \endif */
    OB_PROP_WATCHDOG_BOOL              = 87, /**< \if English Watchdog function switch, 0: Disable, 1: Enable \else  看门狗功能开关，0: Disable， 1: Enable \endif */
    OB_PROP_EXTERNAL_SIGNAL_RESET_BOOL = 88, /**< \if English External signal trigger restart function switch, 0: Disable, 1: Enable \else  外部信号触发重启功能开关，0: Disable， 1: Enable \endif */
    OB_PROP_HEARTBEAT_BOOL             = 89, /**< \if English Heartbeat monitoring function switch, 0: Disable, 1: Enable \else  心跳监测功能开关，0: Disable， 1: Enable \endif */
    ...
    OB_PROP_D2C_PREPROCESS_BOOL        = 91, /**< \if English D2C preprocessing switch (such as RGB cropping), 0: off, 1: on \else  D2C前处理开关（如RGB裁剪），0：关，1：开 \endif */
    ...
    OB_STRUCT_DEVICE_SERIAL_NUMBER           = 1035, /**< \if English get/set serial number \else  get/set序列号 \endif */

 ...
 */
ob_device_info* ob_device_list_get_device_info( ob_device_list* list, uint32_t index, ob_error** error );
 ...
 */
ob_device* ob_get_device( ob_device_list* list, uint32_t index, ob_error** error );
 ...
 * @param[out] error 记录错误信息
 */
void ob_device_set_int_property( ob_device* device, ob_global_unified_property property_id, int32_t property, ob_error** error );
 ...
 * @param[out] error 记录错误信息
 */
void ob_device_set_float_property( ob_device* device, ob_global_unified_property property_id, float property, ob_error** error );
 ...
 * @param[out] error 记录错误信息
 */
void ob_device_set_bool_property( ob_device* device, ob_global_unified_property property_id, bool property, ob_error** error );
 ...
 * @param[out] error 记录错误信息
 */
bool ob_device_set_raw_data( ob_device* device, ob_global_unified_property property_id, void* data, uint32_t data_size, ob_set_data_callback cb, bool async, void* user_data, ob_error** error );
 ...
 * @param[out] error 记录错误信息
 */
bool ob_device_get_raw_data( ob_device* device, ob_global_unified_property property_id, ob_get_data_callback cb, bool async, void* user_data, ob_error** error );
 ...
 */
ob_global_unified_property_item ob_device_get_supported_property( ob_device* device, uint32_t index, ob_error** error );
 ...
 * @param[out] error 记录错误信息
 */
bool ob_device_write_flash( ob_device* device, uint32_t offset, const void* data, uint32_t data_size, ob_set_data_callback cb, bool async, void* user_data, ob_error** error );
 ...
 * @param[out] error 记录错误信息
 */
bool ob_device_read_flash( ob_device* device, uint32_t offset, uint32_t data_size, ob_get_data_callback cb, bool async, void* user_data, ob_error** error );
 ...
 */
bool ob_device_upgrade( ob_device* device, const char* path, ob_device_upgrade_callback callback, bool async, void* user_data, ob_error** error );
